...
// Dynamic Navigation ScrollSpy (Active Underline Highlight on Scroll)
      ...
      <div class="product-card" data-id="${product.id}">
        <div class="product-image-wrap ${hasMultipleImages ? 'has-hover-img' : ''}">
          ...
          ${productImages.length > 0 ? `
            <img src="${productImages[0]}" alt="${pName}" class="product-img ${hasMultipleImages ? 'product-img-primary' : ''}" loading="lazy">
            ${hasMultipleImages ? `
              <img src="${productImages[1]}" alt="${pName} (Вид сзади)" class="product-img product-img-secondary" loading="lazy">
            ` : ''}
          ` : `
